	...
	Example.sprites = function() {
			...
			if (Common.random() < 0.2) {
				return Bodies.rectangle(x, y, 32, 20, {
					...
					render: {
						strokeStyle: '#14151f',
						sprite: {
							texture: '//10.20.209.140:8000/build/img/double11_1.png'
						}
					}
				});
				...
				return Bodies.rectangle(x, y, 32, 30, {
					...
					render: {
						strokeStyle: '#ffffff',
						sprite: {
							texture: '//10.20.209.140:8000/build/img/tmall.png'
						}
					}
				});
				...
				return Bodies.rectangle(x, y, 28, 36, {
					...
					render: {
						strokeStyle: '#ffffff',
						sprite: {
							texture: '//10.20.209.140:8000/build/img/red.png'
						}
					}
				});
			}
			...
			// }
				...
				return Bodies.rectangle(x, y, 30, 30, {
					...
					render: {
						strokeStyle: '#ffffff',
						sprite: {
							texture: '//10.20.209.140:8000/build/img/gift.png'
						}
					}
				});
				...
				return Bodies.circle(x, y, 20, {
					...
					render: {
						sprite: {
							texture: '//10.20.209.140:8000/build/img/coin.png'
						}
					}
				});
				...
				return Bodies.circle(x, y, 16, {
					...
					render: {
						sprite: {
							texture: '//10.20.209.140:8000/build/img/duck.png'
						}
					}
				});
			}else {
				return Bodies.circle(x, y, 22, {
					...
					render: {
						sprite: {
							texture: '//10.20.209.140:8000/build/img/liebao.png'
						}
					}
				});
			}
		...
		var arm = Bodies.rectangle(400, 100, 40, 25, {
			render: {
				strokeStyle: '#3c3f41',
				sprite: {
					texture: '//10.20.209.140:8000/build/img/arm.png'
				}
			}
		});
	...
	Example.sprites.ragdoll = function(x, y, scale, options, vertexSets) {
		...
		var chestOptions = Common.extend({
			...
			render: {
				fillStyle: '#d81e06',
				sprite: {
					texture: '//10.20.209.140:8000/build/img/chest.png'
				}
			}
		}, options);
